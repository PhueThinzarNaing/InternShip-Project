...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <script async src="//jsfiddle.net/ugPxf/embed/"></script>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{ route('myaccount.index') }}" class="d-block">{{ Auth::user()->name }}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <a href="{{ route('commodity_exchanges.index') }}" class="nav-link">
                 <i class="far fa-circle nav-icon"></i>
                  <p>Show Commodity_exchanges</p>
             </a>
             </li>
             @endif
             ...
             @if(Auth::user()->role == 'admin')
               <li class="nav-item">
                <a href="{{ route('commodity_exchanges.create') }}" class="nav-link">

                  <i class="far fa-circle nav-icon"></i>
                    <p>Create Commodity_exchanges</p>
                  </a>
               </li>
          ...
          <li class="nav-item has-treeview">
            ...
            @if(Auth::user()->role == 'admin')
              ...
              <a href="{{ route('itemsprices.index') }}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Show Item Price</p>
              </a>
              </li>
           ...
           @if(Auth::user()->role == 'manager')
              <li class="nav-item">
                <a href="{{ route('itemsprices.create') }}" class="nav-link">

                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Item Price</p>
                </a>
              </li>
           ...
           @if(Auth::user()->role == 'manager')
              <li class="nav-item">
                <a href="{{ route('buyitems.create') }}" class="nav-link">
