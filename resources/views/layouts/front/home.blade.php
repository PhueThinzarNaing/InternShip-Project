	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a  href="{{URL::to('shows')}}" class="nav-link">CommodityExchange</a></li>
	        ...
	        <li class="nav-item dropdown">
              ...
              @foreach( $categories as  $category)
                <a class="dropdown-item" href="{{ route('itemslist.show',$category->id) }}">{{ $category->category_name }}</a>
			 @endforeach
              </div>
    ...
    <section class="ftco-section">
		 ...
		 <form class="form-inline" type="get" action="{{url('search')}}">
            <div class="input-group" style="padding-left:130px">
                <input type="text" class="form-control" size="80" name="search"  placeholder="search by items">
